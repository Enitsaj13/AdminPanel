...
import EmailSmsHistoryContent from '@/components/admin/EmailSmsHistoryContent'
import styles from '@/styles/admin/admin_layout.module.scss'

import { useAppSelector } from '@/rtk/hook'

const EmailSmsHistory: NextPage = () => {
  const { toggleShow } = useAppSelector((state) => state.admin)

  return (
    <>
      <Head>
        <title>EmailSmsHistory | Admin Panel</title>
...
export default EmailSmsHistory
